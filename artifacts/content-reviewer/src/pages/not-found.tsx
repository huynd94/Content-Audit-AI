    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4 py-12">
      <Card className="w-full max-w-xl rounded-[2rem] border-white/70 bg-white/85 shadow-xl shadow-slate-100/60 backdrop-blur-xl">
        <CardContent className="p-8 text-center">
          ...
          <h1 className="mt-5 text-3xl font-semibold text-slate-950">404 - Không tìm thấy trang</h1>
          <p className="mt-3 text-sm leading-6 text-slate-500">
            Đường dẫn này không tồn tại trong ứng dụng hiện tại. Quay về trang chủ để tạo lượt kiểm duyệt mới hoặc mở lịch sử.
          </p>
